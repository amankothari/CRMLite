...
.factory('getsetService', function ($injector) {
    var Opportunitytempdata = {};
    var Contacttempdata = {};
    var Accounttempdata = {};
    var PhoneCalltempdata = {};
    var Tasktempdata = {};
    var tempdata = {};
    return {
        Getdata: function (type) {
            if (type === 3) {
                return Opportunitytempdata;
            }
            if (type === 2) {
                return Contacttempdata;
            }
            if (type === 4210) {
                return PhoneCalltempdata;
            }
            if (type === 4212) {
                return Tasktempdata;
            }
        ...
        //Start Opportunity
        SetAccountfor3: function (input) {
            Opportunitytempdata.Account = input;
        },
        SetContactfor3: function (input) {
            Opportunitytempdata.Contact = input;
        },
        //Start Contact
        SetAccountfor2: function (input) {
            Contacttempdata.Account = "";
            Contacttempdata.Account = input;
        },
        //Start PhoneCall
        Setregardingfor4210: function (input) {
            PhoneCalltempdata.regarding = "";
            PhoneCalltempdata.regarding = input;
        },
        Setfromfor4210: function (input) {
            PhoneCalltempdata.from = "";
            PhoneCalltempdata.from = input;
        },
        Settofor4210: function (input) {
            PhoneCalltempdata.to = "";
            PhoneCalltempdata.to = input;
        },
        //Start PhoneCall
        Setregardingfor4212: function (input) {
            Tasktempdata.regarding = "";
            Tasktempdata.regarding = input;
        },
        reset: function () {
            tempdata = {};
        }
 ...
 .factory('getsetDashboard', function ($injector) {
     var tempdata = {};
     var data = {};
...
.factory('XrmServiceToolkit_Soap', function (localStorageService) {
    ...
    var execute = function (request, bool, callback) {
        ///<summary>
