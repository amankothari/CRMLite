starter.controller('ContactCotroller', function ($scope, $ionicSlideBoxDelegate, $ionicModal, $ionicHistory, $location, $timeout, getsetService, authService, localStorageService, $window, $ionicPopup, $rootScope, XrmServiceToolkit_Soap) {
    ...
    var pagecount = 1; var count = 20; $scope.filterdata = ''; var datatopush = { "PagingCookie": "", "totalrecordcountlimitexceeded": "", "morerecords": "", "totalrecord": "" }; $scope.arrey = [];
    ///Function Init
    $scope.fire = function () {
    ...
    function CrmcontactEntity(response,bool) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var j = 0; j < a.length; j++) {
                ...
                //if (a[j].childNodes[0].innerText == "address1_line2") { newobj.address1_line2 = a[j].childNodes[1].innerHTML }
                //if (a[j].childNodes[0].innerText == "address1_line3") { newobj.address1_line3 = a[j].childNodes[1].innerHTML }
                //if (a[j].childNodes[0].innerText == "address1_fax") { newobj.address1_fax = a[j].childNodes[1].innerHTML }
                //if (a[j].childNodes[0].innerText == "address1_postalcode") { newobj.address1_postalcode = a[j].childNodes[1].innerHTML }               
                ...
                //if (a[j].childNodes[0].innerText == "address1_line1") { newobj.addressline1 = a[j].childNodes[1].innerHTML }
                //if (a[j].childNodes[0].innerText == "address1_postalcode") { newobj.address1_postalcode = a[j].childNodes[1].innerHTML }
                if (a[j].childNodes[0].innerText == "fullname") { newobj.Name = a[j].childNodes[1].innerHTML }
                //if (a[j].childNodes[0].innerText == "firstname") { newobj.firstname = a[j].childNodes[1].innerHTML }
                //if (a[j].childNodes[0].innerText == "lastname") { newobj.lastname = a[j].childNodes[1].innerHTML }
                ...
                //if (a[j].childNodes[0].innerText == "parentcustomerid") { newobj.parentcustomerid = a[j].childNodes[1].innerHTML }

                //if (a[j].childNodes[0].innerText == "mobilephone") {
                //    newobj.mobilephone = a[j].childNodes[1].innerHTML;
                //    alert(newobj.mobilephone);
                //}                
            }
    ...
    $scope.Details = function (data) {
        ...
        } else if (getsetService.Getdata().redirecturloppo) {
    ...
    $scope.$on('$ionicView.enter', function () {
        $scope.contactData = getsetService.Getdata();
    })
