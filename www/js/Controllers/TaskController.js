starter.controller('TaskController', function ($cordovaDatePicker, $scope, $ionicSlideBoxDelegate, $ionicModal, $ionicHistory, notification, $location, $timeout, getsetService, localStorageService, $window, $ionicPopup, $rootScope, XrmServiceToolkit_Soap, $ionicPopover) {
    ...
    $scope.taskData = [];
    $scope.$on('$ionicView.enter', function () {$scope.taskData = getsetService.Getdata();})   
    ...
    function AddTask() {
        ...
        function createupdate() { 
            ...
            $scope.taskData.regardingobjectid ? createContact.attributes["regardingobjectid"] = { id: $scope.taskData.regardingobjectid, logicalName: $scope.senddata, type: "EntityReference" } : ""
    ...
    $scope.fetchaccounttask = function (entity, $event) {
        ...
        getsetService.reset();
        getsetService.SetRedirectUrlTask();
